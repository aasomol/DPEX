...
private:
    ...
    void checkControlActions();
    bool addControlVar(GroundedVar* v, std::vector<GroundedControlVar>& controlVars);
    void reshapeCondition(GroundedAction* a, GroundedNumericCondition* c, GroundedControlVar* cv);
    void generateControlVarConditions(GroundedControlVar* cv, GroundedAction* a);
